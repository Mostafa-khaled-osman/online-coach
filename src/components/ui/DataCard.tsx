...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-slate-200 bg-surface text-slate-950 shadow-card",
      className
    )}
    {...props}
  />
...
export { DataCard, DataCardHeader, DataCardFooter, DataCardTitle, DataCardDescription, DataCardContent }
